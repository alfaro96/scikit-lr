...
__all__ = [
    "load_authorship", "load_bodyfat", "load_blocks",
    "load_breast", "load_calhousing", "load_cold",
    "load_cpu", "load_diau", "load_dtt", "load_ecoli",
    "load_elevators", "load_fried", "load_glass",
    "load_heat", "load_housing", "load_iris", "load_letter",
    "load_libras", "load_pendigits", "load_satimage",
