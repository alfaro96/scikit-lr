...
class BaseDecisionTree(BaseEstimator, ABC):
    ...
    def get_n_internal(self):
        ...
        # Return the number of internal nodes of the tree
    ...
    def fit(self, X, Y, sample_weight=None):
        ...
        # Only considers the samples positively weighted.
        # Also, transform the rankings for properly handle
        # them in Cython
        ...
        # The minimum number of samples to split an inner node
        ...
        # The maximum number of features considered at each internal node
        ...
        # The maximum number of splits considered at each internal node
        ...
        # Initialize the sorted indexes (use argsort of NumPy since
        # it is as efficient as the C++ implemented version)
    ...
    def predict(self, X):
        ...
        # Obtain the predictions using the underlying tree
...
class DecisionTreeLabelRanker(LabelRankerMixin, BaseDecisionTree):
    ...
    tree_ : Tree object
        ...
        ``help(plr.tree._tree.Tree)`` for attributes of Tree object.
