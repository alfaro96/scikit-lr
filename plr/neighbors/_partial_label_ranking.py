"""Nearest Neighbor Partial Label Ranking."""
...
# K-Nearest Neighbors
# =============================================================================
class KNeighborsPartialLabelRanker(
        BaseNeighbors, KNeighborsMixin, PartialLabelRankerMixin):
    ...
    >>> model = KNeighborsPartialLabelRanker(n_neighbors=3)
    >>> clf = model.fit(X, Y)
