...
def configuration(parent_package = "",
                  top_path       = None):
    """
        Configure "bucket" package.
    """
    # Initialize the configuration for the "bucket" package
    config    = Configuration("bucket", parent_package, top_path)
    libraries = []
    ...
    # Return the configuration for the "bucket" package
    return config
