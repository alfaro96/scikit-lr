...
def load_data(module_path, data_filename):
    ...
    # Finally, read the .csv files containing the data and the rankings
    if exists_ranks_lr:
...
def load_authorship():
    ...
    >>> from plr.datasets import load_authorship
...
def load_bodyfat():
    ...
    >>> from plr.datasets import load_bodyfat
    >>> data = load_bodyfat()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[7, 6, 2, 1, 5, 3, 4],
           [3, 7, 5, 2, 6, 1, 4],
...
def load_blocks():
    ...
    >>> from plr.datasets import load_blocks
    >>> data = load_blocks()
    >>> data.ranks_lr
    >>> data.ranks_plr[[10, 25, 50]]
    array([[1, 2, 2, 2, 2],
...
def load_breast():
    ...
    >>> from plr.datasets import load_breast
    >>> data = load_breast()
    >>> data.ranks_lr
    >>> data.ranks_plr[[10, 25, 50]]
    array([[1, 2, 2, 2, 2, 2],
...
def load_calhousing():
    ...
    >>> from plr.datasets import load_calhousing
...
def load_cold():
    ...
    >>> from plr.datasets import load_cold
    >>> data = load_cold()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[1, 3, 2, 4],
           [4, 2, 1, 3],
...
def load_cpu():
    ...
    >>> from plr.datasets import load_cpu
    >>> data = load_cpu()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[4, 1, 2, 3, 5],
           [4, 1, 2, 3, 5],
...
def load_diau():
    ...
    >>> from plr.datasets import load_diau
    >>> data = load_diau()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[2, 1, 3, 5, 4, 7, 6],
           [2, 3, 1, 4, 5, 6, 7],
...
def load_dtt():
    ...
    >>> from plr.datasets import load_dtt
    >>> data = load_dtt()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[3, 4, 1, 2],
           [1, 2, 4, 3],
...
def load_ecoli():
    ...
    >>> from plr.datasets import load_ecoli
    >>> data = load_ecoli()
    >>> data.ranks_lr
    >>> data.ranks_plr[[10, 25, 50]]
...
def load_elevators():
    ...
    >>> from plr.datasets import load_elevators
    >>> data = load_elevators()
    >>> data.ranks_lr[[10, 25, 50]]
...
def load_fried():
    ...
    >>> from plr.datasets import load_fried
    >>> data = load_fried()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[4, 2, 3, 5, 1],
           [3, 5, 1, 2, 4],
...
def load_glass():
    ...
    >>> from plr.datasets import load_glass
    >>> data = load_glass()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[1, 3, 2, 4, 5, 6],
           [1, 3, 2, 4, 5, 6],
...
def load_heat():
    ...
    >>> from plr.datasets import load_heat
    >>> data = load_heat()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[6, 5, 1, 4, 3, 2],
           [1, 6, 3, 5, 4, 2],
...
def load_housing():
    ...
    >>> from plr.datasets import load_housing
    >>> data = load_housing()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[2, 1, 4, 5, 6, 3],
           [2, 3, 6, 5, 1, 4],
...
def load_letter():
    ...
    >>> from plr.datasets import load_letter
    >>> data = load_letter()
    >>> data.ranks_lr
    >>> data.ranks_plr[[10, 25, 50]]
    array([[1, 2, 2, 2, 2, 2, 2, 2],
...
def load_libras():
    ...
    >>> from plr.datasets import load_libras
    >>> data = load_libras()
    >>> data.ranks_lr
    >>> data.ranks_plr[[10, 25, 50]]
...
def load_pendigits():
    ...
    >>> from plr.datasets import load_pendigits
    >>> data = load_pendigits()
    >>> data.ranks_lr[[10, 25, 50]]
...
def load_satimage():
    ...
    >>> from plr.datasets import load_satimage
    >>> data = load_satimage()
    >>> data.ranks_lr
    >>> data.ranks_plr[[10, 25, 50]]
    array([[2, 2, 2, 1, 2, 2],
...
def load_segment():
    ...
    >>> from plr.datasets import load_segment
    >>> data = load_segment()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[3, 7, 4, 1, 2, 5, 6],
           [2, 7, 3, 4, 1, 6, 5],
...
def load_shuttle():
    ...
    >>> from plr.datasets import load_shuttle
    >>> data = load_shuttle()
    >>> data.ranks_lr
    >>> data.ranks_plr[[10, 25, 50]]
    array([[1, 2, 2, 2, 2, 2, 2],
...
def load_spo():
    ...
    >>> from plr.datasets import load_spo
    >>> data = load_spo()
    >>> data.ranks_lr[[10, 25, 50]]
...
def load_stock():
    ...
    >>> from plr.datasets import load_stock
    >>> data = load_stock()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[1, 3, 5, 2, 4],
           [1, 3, 5, 2, 4],
...
def load_vehicle():
    ...
    >>> from plr.datasets import load_vehicle
    >>> data = load_vehicle()
    >>> data.ranks_lr[[10, 25, 50]]
    array([[2, 3, 4, 1],
           [3, 4, 2, 1],
...
def load_vowel():
    ...
    >>> from plr.datasets import load_vowel
    >>> data = load_vowel()
    >>> data.ranks_lr[[10, 25, 50]]
...
def load_wisconsin():
    ...
    >>> from plr.datasets import load_wisconsin
    >>> data = load_wisconsin()
    >>> data.ranks_lr[[10, 25, 50]]
...
def load_yeast():
    ...
    >>> from plr.datasets import load_yeast
    >>> data = load_yeast()
    >>> data.ranks_lr
    >>> data.ranks_plr[[10, 25, 50]]
