...
def check_consistent_length(*arrays):
    ...
    *arrays : {list, tuple} of input arrays.
    ...
    """
    # Remove the None values from the arrays
...
def check_array(array, dtype=None, force_all_finite=True, ensure_2d=True):
    ...
    # Check that the data type of the input array
    ...
    # Check whether the array contain infinite values when they are not allowed
...
def check_is_fitted(estimator):
    ...
    """
    # Check if the estimator is an object
    if isclass(estimator):
        raise TypeError("{} is a class, not an instance.".format(estimator))

    # Check if the given object is an estimator
...
def has_fit_parameter(estimator, parameter):
    ...
    >>> has_fit_parameter(KNeighborsLabelRanker(), "sample_weight")
    False
    >>> has_fit_parameter(DecisionTreeLabelRanker(), "sample_weight")
    True
    """
